...
CREATE DATABASE IF NOT EXISTS rgpd_etablissement CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE rgpd_etablissement;
...
-- Mot de passe : bcrypt('Oliv2001!')
-- Exemple : $2y$10$u/nhHzTniqGy8ZtnBv1jK.zv4HrMezXxMIGs.F/33VZzvzLzEdbFu
-- ==========================================================
...
-- ==========================================================
-- Données de test : questions d’exemple
-- ==========================================================

INSERT INTO questions (fonction_cible, question_txt, type_reponse, options_reponse) VALUES
('Enseignante', 'Utilisez-vous des outils cloud (Google, Padlet, ENT, etc.) pour partager des documents ?','choix','["Oui","Non"]'),
('Enseignante', 'Demandez-vous le consentement des parents pour publier des photos d’élèves ?','choix','["Toujours","Parfois","Jamais"]'),
('CPE', 'Comment conservez-vous les dossiers disciplinaires des élèves ?','texte',NULL),
('Secrétaire', 'Les dossiers d’inscription contiennent-ils des informations médicales ?','choix','["Oui","Non"]');
...
VALUES
('Dossiers élèves', 'Suivi administratif de la scolarité', 'Identité, santé, contact parent', 'Mission d’intérêt public', 'Élèves et parents', 'Chef d’établissement', 'Durée de la scolarité + 1 an', 'Serveur académique', 'Accès restreint, chiffrement, sauvegardes', 'ENT académique', 1),
('Gestion du personnel', 'Gestion RH et paie des salariés', 'Données personnelles, bancaires', 'Obligation légale', 'Personnel de l’établissement', 'Chef d’établissement', 'Fin du contrat + 5 ans', 'Serveur OGEC', 'Accès réservé, chiffrement', 'OGEC, cabinet comptable', 0);
